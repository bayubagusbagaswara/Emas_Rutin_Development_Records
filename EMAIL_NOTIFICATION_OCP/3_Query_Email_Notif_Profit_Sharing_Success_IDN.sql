INSERT INTO NOTIFICATION_MANAGEMENT_SERVICE.NOTIFICATION_TEMPLATE (ID,CREATED_BY,CREATED_DATE,"LANGUAGE",MESSAGE_SENDER,MESSAGE_SUBJECT,MODIFIED_BY,MODIFIED_DATE,TEMPLATE_CODE,TEMPLATE_TYPE,MESSAGE_CONTENT,ICON,MESSAGE_TITLE,ACTION_INFO,ACTION_LINK,ADDITIONAL_INFO) VALUES
	 (182,'SYSTEM',NULL,'IDN','Bank Syariah Indonesia<development.bsi@ist.id>','Pengajuan Beli Emas Rutin Berhasil',NULL,NULL,'REGISTER_BELI_EMAS_RUTIN_BAGIHASIL_SUCCESS','EMAIL',TO_CLOB('<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
              ...
              <td style="padding: 16px 0px; background-color: #ffffff">
                ...
                >
                  <tbody>
                    <tr>
                      <td
                        style="
                          ')||TO_CLOB('padding: 25px 24px 24px 32px;
                          background-color: #fafafa;
                          border-bottom: 1px solid #e0e0e0;
                          width: 10px;
                          font-size: 14px;
                ...
                ')||TO_CLOB('          background-color: #fafafa;
                    ...
                    <tr>
                      <td
                        style="
                          padding: 2')||TO_CLOB('5px 24px 24px 32px;
                          background-color: #fafafa;
                          border-bottom: 1px solid #e0e0e0;
                          width: 10px;
                          font-size: 14px;
                      ...
                      <td style="padding: 0px 0px">
                        ...
                        <p style="text-align: center">
                          <a href="https://bankbsi.id/facebook_bsi">
                            <img
                              src="https://storage.googleap')||TO_CLOB('is.com/bsisuperapp2.bankbsi.co.id/assets/email/icon-facebook.png"
                              style="width: 30px"
                            />
                          </a>
